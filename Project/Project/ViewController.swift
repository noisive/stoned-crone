    ...
    func makeMakeData() {
        ...
        importer.startImportingRecords { $0 }.onFinish { importedRecords in
            for record in importedRecords {
                ...
                //Create a new lesson
                let newLesson = Lesson(classID: paperCode, start: startTime!, length: duration!, code: paperCode, type: types, roomShort: roomCode, roomFull: roomName, paperName: paperName, day: dayNumber)
